...
apt-get update
apt-get install -y cron python python3 vim bc apache2 php php-gd php-curl php-xml php-json libapache2-mod-php jq  i2c-tools git mosquitto mosquitto-clients socat python3-pip sshpass
echo "...done"
...
if [ ! -d /var/www/html/openWB/web ]; then
	cd /var/www/html/
	git clone https://github.com/xerion3800/openWB.git --branch master
